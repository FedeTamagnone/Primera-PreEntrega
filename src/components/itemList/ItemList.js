...
const ItemList = () => {
    ...
    const listaDeProductos =[
            {id: 1, nombre: "Low Poo Argán", tipo: "shampoo", marca: "argan" ,desc: "Limpia el cabello de una manera suave, dejándolo con brillo, sedosidad y luminosidad ", precio: 1200,stock:10, img:'multimedia/bekim-img1.jpg'},
            ...
            {id: 6, nombre: "Low Crema", tipo: "crema", marca: "argan",desc: "Limpia el cabello de una manera suave, dejándolo con brillo, sedosidad y luminosidad ", precio: 3000,stock:6}
        ] 
